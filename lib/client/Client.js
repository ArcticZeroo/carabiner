...
class Client extends EventEmitter {
    ...
    constructor(token, opts = {}) {
         ...
         * @type {module:enmap.Enmap.<number, Conversation>}
         */
    ...
    _extendApiEvents() {
         ...
         * @param {Conversation} data.channel - The conversation the member joined.
         ...
         * @param {String} oldName - The old team name
         */
        emitter.on('team_rename', (data) => {
            const oldName = this.team.name;
            this.team.name = data.name;
            this.emit('teamRename', this.team.name, oldName);
        });
    }
