...
class Channel {
    ...
    setup(data) {
         ...
         * @readonly
         */
        Object.defineProperty(this, 'creator', {value: this.client.users.find('id', data.creator)});

        /**
         * The slack timestamp of the channel's creation
         * You might be looking for {Channel#created}
        ...
        /**
         * The members of the channel, as {User}s
         * @type {Collection}
         */
        ...
        if (data.members) {
            for (const mId of data.members) {
                this.members.set(mId, this.client.members.find('id', mId));
            }
        }
