...
class User extends Structure {
	...
	/**
     * Set whether this user should be disabled or not
	 * @param  {boolean} disabled - Whether this user should be disabled.
	 * @private
	 */
	_setDisabled(disabled) {
		 ...
		 * @type {boolean}
		 */
		this.isDeleted = this.isDisabled = disabled;
    }
    ...
    setup(data) {
        ...
        this._setDisabled(this.deleted);
