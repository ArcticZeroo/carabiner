...
class SlackUtil {
    ...
    static async getPages({ method, args, getData, pageLimit = Number.POSITIVE_INFINITY, singlePageLimit = 100 }) {
        const data = [];
        ...
        for (let i = 0; i < pageLimit; i++) {
            ...
            // If return is null or empty string
            if (!SlackUtil.getNextCursor(res)) {
                break;
            }
        }
